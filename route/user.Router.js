...
let transactionController = require("../controller/transaction.controller.js");
router.post('/createtransaction',transactionController.createTransaction);
router.get('/getalltransactions',transactionController.getAllTransactions);
// router.get('/gettransactionbyid/:id',transactionController.getSingleTransaction);
router.put('/updatetransactionpayment/:id',transactionController.addPayment);
module.exports = router;
